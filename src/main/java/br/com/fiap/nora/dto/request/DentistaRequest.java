...
public class DentistaRequest {
    ...
    public DentistaRequest(String nome, String cro, String telefone, String email, String tgChatId,
                           int capMensal, String status, String cep, String logradouro, String numero,
